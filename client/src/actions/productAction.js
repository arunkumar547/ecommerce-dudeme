...
export const getProducts = (keyword = '', currentPage = 1, price, category, rating) => async (dispatch) => {
    try {
        ...
        let link = `/api/products/products/?keyword=${keyword}&page=${currentPage}&price[lte]=${price[1]
            }&price[gte]=${price[0]}&ratings[gte]=${rating}`

        if (category) {
            link = `/api/products/products/?keyword=${keyword}&page=${currentPage}&price[lte]=${price[1]
...
export const updateProduct = (id, productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/products/admin/product/${id}`, productData, config)
