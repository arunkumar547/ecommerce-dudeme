...
const ProductDetails = ({match}) => {
    ...
    const increaseQty=()=>{
        ...
        // console.log("COUNTvalueAsNumber",count.value)
        // console.log("typeof(COUNT)",typeof(count.valueAsNumber))
    ...
    const decreaseQty=()=>{
        const count=document.querySelector('.count')
        // console.log(count.valueAsNumber,"value")
    ...
    function setUserRatings() {
        ...
        stars.forEach((star, index) => {
            ...
            // console.log("star11",star)
            // console.log("star.starvalue",star.starValue);
